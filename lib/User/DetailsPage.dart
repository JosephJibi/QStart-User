        ...
        Row(
          ...
          children: [
            ...
            IconButton(
                color: Colors.white,
                padding: EdgeInsets.only(
                    top: Dimensions.height98, right: Dimensions.width20),
                onPressed: () {
                  popUpBox(context);
                },
                icon: Icon(
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      (document['declinemsg'] != '')
                          ? Text(
                              'Pending due to :' + document['declinemsg'],
                              style: GoogleFonts.poppins(
                                  fontSize: Dimensions.height15,
                                  color: const Color.fromARGB(255, 71, 83, 90)),
                            )
                          : (document['pendingmsg'] != '')
                              ? Text(
                                  'Pending due to :' + document['pendingmsg'],
                                  style: GoogleFonts.poppins(
                                      fontSize: Dimensions.height15,
          ...
          return AlertDialog(
            ...
            content: Container(
              ...
              child: ListView(children: [
                ...
                Text(
                  'Do you need delete this complaint?',
                  style: GoogleFonts.poppins(
                      fontSize: Dimensions.height20,
                      fontWeight: FontWeight.w500),
                ),
                      ...
                      TextButton(
                          onPressed: () {
                            if (document['status'] == 'Requested') {
                              ...
                              Get.snackbar('Permission Denied ⚠️',
                                  'Your complaint is already declined, You can\'t delete it now...');
                            } else {
                              Get.snackbar('Permission Denied ⚠️',
                                  'Your complaint is under process, You can\'t delete it now...');
                            }
                            Navigator.of(ctx).pop();
                            Navigator.of(ctx).pop();
                          },
